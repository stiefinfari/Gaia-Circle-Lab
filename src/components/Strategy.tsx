        ...
        <div className="max-w-4xl mx-auto glass p-6 md:p-16 rounded-3xl border border-white/10 shadow-neon-blue relative overflow-hidden">
          ...
          <div className="mt-12 text-center relative z-10">
            <button
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-white/5 border border-white/10 rounded-full hover:bg-white/10 hover:border-white/30 transition-all duration-300 group cursor-pointer"
            >
        ...
        {isModalOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-black border border-white/10 rounded-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto p-6 md:p-12 relative shadow-2xl shadow-neon-blue/20"
