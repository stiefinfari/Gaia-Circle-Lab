  ...
  const services = [
    {
      ...
      description: 'Dall\'identità visiva allo sviluppo di siti portfolio e vetrina. Progettiamo interfacce pulite, moderne e funzionali, pensate per valorizzare il brand e comunicare con chiarezza.',
    ...
    {
      title: 'Eventi & Experience Design',
      description: 'Dagli eventi aziendali alle esperienze immersive dal vivo. Curiamo la direzione artistica, il concept visivo e la regia audio-video per creare momenti che uniscono luce, immagine e atmosfera, lasciando un ricordo indelebile.',
    ...
    },
    {
      ...
      description: 'Supporto strategico per l\'allineamento ai marchi di qualità regionali. Valorizziamo l\'eccellenza del Made in Italy attraverso un\'identità visiva che comunica autenticità, sostenibilità e innovazione.',
  ...
  return (
    <section id="services" className="py-24 bg-black text-white relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute top-0 right-0 w-48 h-48 md:w-64 md:h-64 border border-white/5 rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none" 
      />
      <motion.div 
        animate={{ rotate: -360 }}
        transition={{ duration: 120, repeat: Infinity, ease: "linear" }}
        className="absolute bottom-0 left-0 w-64 h-64 md:w-96 md:h-96 border border-white/5 rounded-full translate-y-1/2 -translate-x-1/3 pointer-events-none" 
      />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-display font-bold tracking-wider uppercase mb-4 drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">L'Offerta Gaia Circle Lab</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`glass p-6 md:p-10 rounded-2xl group hover:bg-white/5 transition-all duration-500 flex flex-col relative overflow-hidden h-full ${service.color}`}
            >
              ...
              <div className="mt-auto relative z-10 pt-6 border-t border-white/5">
                ...
                <ul className="text-sm text-gray-400 space-y-1">
                   {index === 0 && (
                     <>
                       <li>• Identità visiva forte e riconoscibile</li>
                       <li>• Design moderno e user-friendly</li>
                       <li>• Ottimizzazione per mobile e SEO</li>
                     </>
                   )}
                   {index === 1 && (
                     <>
