      ...
      <main className="pt-24">
        <section className="py-12 md:py-24 bg-black text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              <h2 className="text-4xl md:text-6xl font-display font-bold tracking-wider uppercase mb-4 text-transparent bg-clip-text bg-gradient-to-r from-neon-blue via-neon-purple to-neon-pink drop-shadow-lg">
                Studio 16
              </h2>
